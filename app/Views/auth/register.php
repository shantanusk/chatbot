...
<body>
    <div class="glass-strong rounded-3xl w-full max-w-md p-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-white/90 text-2xl font-semibold">Create Account</h1>
            <p class="text-white/50 text-sm mt-1">Start chatting with AI</p>
        </div>
        ...
        <form method="post" class="space-y-4">
            <div>
                <label class="text-white/60 text-xs font-medium block mb-1.5">Username</label>
                <input type="text" name="username" placeholder="Choose a username" required autofocus>
            </div>
            <div>
                <label class="text-white/60 text-xs font-medium block mb-1.5">Email</label>
                <input type="email" name="email" placeholder="Enter your email" required>
            </div>
            <div>
                <label class="text-white/60 text-xs font-medium block mb-1.5">Password</label>
                <input type="password" name="password" placeholder="Choose a password (min 4 chars)" required minlength="4">
            </div>
